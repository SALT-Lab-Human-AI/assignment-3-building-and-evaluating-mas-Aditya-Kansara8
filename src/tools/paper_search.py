...
class PaperSearchTool:
    ...
    async def search(
        ...
        **kwargs
        ...
        # SEMANTIC SCHOLAR API DISABLED - Commented out for now
        self.logger.info("Semantic Scholar API is currently disabled")
        return []
...
def paper_search(query: str, max_results: int = 10, year_from: Optional[int] = None) -> str:
    ...
    """
    # SEMANTIC SCHOLAR API DISABLED - Commented out for now
    return "Paper search (Semantic Scholar) is currently disabled."
